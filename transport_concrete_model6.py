...
print('--- Model Solver ---')
# solver = 'cbc'
# solver = 'bonmin' # Heuristic MINLP solver
# solver = 'couenne' #  Deterministic global MINLP solver
# solver = 'appsi_highs'
solver = 'cplex'
...
if solver == 'cplex':
    ...
    results = opt.solve(model, tee=True, warmstart=True)  # tee=True for details
elif solver == 'gurobi_direct':
