#  MINLP written by GAMS Convert at 05/24/17 13:23:30
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.x937 = Var(within=Reals,bounds=(None,1.1),initialize=1)

m.obj = Objective(expr=m.x937, sense=minimize)
...
m.c382 = Constraint(expr=-0.000149225466448718*(6750 + 1.3163e-9*(478.333333333333*m.x931)**4 - 3.8347e-6*(
...
m.c383 = Constraint(expr=-0.000149225466448718*(6750 + 1.3163e-9*(478.333333333333*m.x932)**4 - 3.8347e-6*(
...
m.c921 = Constraint(expr=   10*m.x3 + 10*m.x4 + 10*m.x5 + 10*m.x6 - 0.001*m.b7 - 0.001*m.b8 - 1000*m.x9
                          + 0.446716681462014*m.x10 - 1000*m.x937 == 0)
