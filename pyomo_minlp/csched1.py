...
m.c1 = Constraint(expr=(-m.x13*m.x77) - (416000*(1 - exp(-0.1*m.x1/m.x4))*m.x4 + 37440*m.x1 - 100*m.x4 + 
                       124615.384615385*(1 - exp(-0.13*m.x2/m.x5))*m.x5 + 9000*m.x2 - 90*m.x5 + 278666.666666667*(1 - 
                       exp(-0.09*m.x3/m.x6))*m.x6 + 15840*m.x3 - 80*m.x6) == 0)
