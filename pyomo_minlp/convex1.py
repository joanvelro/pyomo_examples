...
m.x13 = Var(within=Reals,bounds=(4.45966260231685,5.93950480817727),initialize=4.45966260231685)
m.x14 = Var(within=Reals,bounds=(3.74950407593037,6.78259213602813),initialize=3.74950407593037)
m.x15 = Var(within=Reals,bounds=(4.49144142065975,6.72543372218818),initialize=4.49144142065975)
m.x16 = Var(within=Reals,bounds=(3.14988295338125,6.45880505893423),initialize=3.14988295338125)
m.x17 = Var(within=Reals,bounds=(3.04452243772342,6.50229017087397),initialize=3.04452243772342)
m.x18 = Var(within=Reals,bounds=(0.729961153682662,2.11625551480255),initialize=0.729961153682662)
m.x19 = Var(within=Reals,bounds=(0.53062825106217,1.91692261218206),initialize=0.53062825106217)
m.x20 = Var(within=Reals,bounds=(1.09024403899759,2.47653840011748),initialize=1.09024403899759)
m.x21 = Var(within=Reals,bounds=(-0.133531392624523,1.25276296849537),initialize=-0.133531392624523)
m.x22 = Var(within=Reals,bounds=(0.048790164169432,1.43508452528932),initialize=0.048790164169432)
