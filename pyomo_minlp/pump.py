#  MINLP written by GAMS Convert at 05/24/17 13:23:47
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         35       14        0       21        0        0        0        0
...
m.x1 = Var(within=Reals,bounds=(0,80),initialize=30)
...
m.x5 = Var(within=Reals,bounds=(0,2950),initialize=0)
m.x6 = Var(within=Reals,bounds=(0,2950),initialize=0)
m.x7 = Var(within=Reals,bounds=(0,400),initialize=400)
m.x8 = Var(within=Reals,bounds=(0,400),initialize=0)
m.x9 = Var(within=Reals,bounds=(0,400),initialize=0)
m.x10 = Var(within=Reals,bounds=(0,350),initialize=150)
m.x11 = Var(within=Reals,bounds=(0,350),initialize=0)
m.x12 = Var(within=Reals,bounds=(0,350),initialize=0)
...
m.i16 = Var(within=Integers,bounds=(0,3),initialize=0)
m.i17 = Var(within=Integers,bounds=(0,3),initialize=0)
m.i18 = Var(within=Integers,bounds=(0,3),initialize=0)
m.i19 = Var(within=Integers,bounds=(0,3),initialize=0)
m.i20 = Var(within=Integers,bounds=(0,3),initialize=0)
m.i21 = Var(within=Integers,bounds=(0,3),initialize=0)
