#  MINLP written by GAMS Convert at 05/24/17 13:23:49
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         73       10       33       30        0        0        0        0
...
m.x61 = Var(within=Reals,bounds=(-10000000,None),initialize=0)
...
m.c73 = Constraint(expr=   m.x61 - m.x62 - m.x63 - m.x64 - m.x65 - m.x66 - m.x67 - m.x68 - m.x69 - 2*m.x70 == 0)
