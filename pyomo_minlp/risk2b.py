#  MINLP written by GAMS Convert at 05/24/17 13:23:48
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.x462 = Var(within=Reals,bounds=(None,None),initialize=0.5)
m.x463 = Var(within=Reals,bounds=(None,None),initialize=0.5)
m.x464 = Var(within=Reals,bounds=(None,None),initialize=0.5)
