...
m.c82 = Constraint(expr=-10*(1.521*m.x41 - 0.5161*m.x37*m.x41 - 0.0352*m.x43*m.x41 + 0.0628*m.x37*m.x37*m.x41 + 0.01*
                        m.x37*m.x43*m.x41 - 0.0022*m.x37*m.x37*m.x37*m.x41 - 0.0009*m.x37*m.x37*m.x43*m.x41) + m.x330
                         == 0)

m.c83 = Constraint(expr=-10*(1.521*m.x52 - 0.5161*m.x48*m.x52 - 0.0352*m.x54*m.x52 + 0.0628*m.x48*m.x48*m.x52 + 0.01*
                        m.x48*m.x54*m.x52 - 0.0022*m.x48*m.x48*m.x48*m.x52 - 0.0009*m.x48*m.x48*m.x54*m.x52) + m.x331
                         == 0)

m.c84 = Constraint(expr=-10*(1.521*m.x63 - 0.5161*m.x59*m.x63 - 0.0352*m.x65*m.x63 + 0.0628*m.x59*m.x59*m.x63 + 0.01*
                        m.x59*m.x65*m.x63 - 0.0022*m.x59*m.x59*m.x59*m.x63 - 0.0009*m.x59*m.x59*m.x65*m.x63) + m.x332
                         == 0)
...
m.c280 = Constraint(expr=-1000*(0.027*m.x258**2 - 0.3008*m.x258) + m.x300 == 1063.3)

m.c281 = Constraint(expr=-1000*(0.027*m.x259**2 - 0.3008*m.x259) + m.x301 == 1063.3)

m.c282 = Constraint(expr=-1000*(0.027*m.x260**2 - 0.3008*m.x260) + m.x302 == 1063.3)
