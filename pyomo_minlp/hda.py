#  MINLP written by GAMS Convert at 05/24/17 13:23:24
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.x723 = Var(within=Reals,bounds=(-100000000,None),initialize=0)

m.obj = Objective(expr=m.x723, sense=minimize)
