...
m.c192 = Constraint(expr=-(250*(exp(0.6*m.x1 + m.x37 + m.x43) + exp(0.6*m.x2 + m.x38 + m.x44) + exp(0.6*m.x3 + m.x39 + 
                         m.x45) + exp(0.6*m.x4 + m.x40 + m.x46) + exp(0.6*m.x5 + m.x41 + m.x47) + exp(0.6*m.x6 + m.x42
                          + m.x48)) + 150*exp(0.5*m.x50)) + m.x49 == 0)
