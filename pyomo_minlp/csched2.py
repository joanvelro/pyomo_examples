...
m.c1 = Constraint(expr=(-m.x92*m.x401) - (479700*(1 - exp(-0.1*m.x1/m.x29))*m.x29 + 31980*m.x1 - 100*m.x29 + 252000*(1
                        - exp(-0.2*m.x2/m.x30))*m.x30 + 22680*m.x2 - 90*m.x30 + 423500*(1 - exp(-0.1*m.x3/m.x31))*m.x31
                        + 25410*m.x3 - 80*m.x31 + 157440*(1 - exp(-0.2*m.x4/m.x32))*m.x32 + 19680*m.x4 - 75*m.x32 + 
                       172108.695652174*(1 - exp(-0.23*m.x5/m.x33))*m.x33 + 40950*m.x5 - 90*m.x33 + 33970.5882352941*(1
                        - exp(-0.34*m.x6/m.x34))*m.x34 + 8580*m.x6 - 93*m.x34 + 130200*(1 - exp(-0.2*m.x7/m.x35))*m.x35
                        + 13440*m.x7 - 78*m.x35 + 200640*(1 - exp(-0.2*m.x8/m.x36))*m.x36 + 26334*m.x8 - 80*m.x36 + 
                       526680*(1 - exp(-0.1*m.x9/m.x37))*m.x37 + 26334*m.x9 - 85*m.x37 + 212850*(1 - exp(-0.2*m.x10/
                       m.x38))*m.x38 + 29670*m.x10 - 75*m.x38 + 141360*(1 - exp(-0.25*m.x11/m.x39))*m.x39 + 28500*m.x11
                        - 90*m.x39 + 152937.931034483*(1 - exp(-0.29*m.x12/m.x40))*m.x40 + 49104*m.x12 - 94*m.x40 + 
                       76444.4444444444*(1 - exp(-0.27*m.x13/m.x41))*m.x41 + 13932*m.x13 - 78*m.x41 + 76840*(1 - exp(-
                       0.3*m.x14/m.x42))*m.x42 + 11526*m.x14 - 70*m.x42 + 102300*(1 - exp(-0.3*m.x15/m.x43))*m.x43 + 
                       18810*m.x15 - 90*m.x43 + 170800*(1 - exp(-0.2*m.x16/m.x44))*m.x44 + 17568*m.x16 - 90*m.x44 + 
                       115200*(1 - exp(-0.3*m.x17/m.x45))*m.x45 + 20160*m.x17 - 90*m.x45 + 176000*(1 - exp(-0.27*m.x18/
                       m.x46))*m.x46 + 30360*m.x18 - 85*m.x46 + 126357.142857143*(1 - exp(-0.28*m.x19/m.x47))*m.x47 + 
                       36600*m.x19 - 93*m.x47 + 45931.0344827586*(1 - exp(-0.29*m.x20/m.x48))*m.x48 + 9000*m.x20 - 92*
                       m.x48 + 123318*(1 - exp(-0.25*m.x21/m.x49))*m.x49 + 17901*m.x21 - 75*m.x49 + 223200*(1 - exp(-0.2
                       *m.x22/m.x50))*m.x50 + 28800*m.x22 - 80*m.x50 + 225000*(1 - exp(-0.2*m.x23/m.x51))*m.x51 + 23750*
                       m.x23 - 90*m.x51 + 240800*(1 - exp(-0.15*m.x24/m.x52))*m.x52 + 21672*m.x24 - 85*m.x52 + 115920*(1
                        - exp(-0.25*m.x25/m.x53))*m.x53 + 19320*m.x25 - 80*m.x53 + 133241.379310345*(1 - exp(-0.29*m.x26
                       /m.x54))*m.x54 + 42780*m.x26 - 92*m.x54 + 90763.6363636364*(1 - exp(-0.22*m.x27/m.x55))*m.x55 + 
                       13312*m.x27 - 85*m.x55 + 78857.1428571429*(1 - exp(-0.28*m.x28/m.x56))*m.x56 + 11730*m.x28 - 72*
                       m.x56) == 0)
