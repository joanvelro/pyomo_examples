...
m.c101 = Constraint(expr=-log(1 + (312.5 + 625*m.x290)/(m.x284*m.x266*m.x267*m.x268*m.x269)*(1 - 0.24*(1 - exp(-1.5*
...
m.c118 = Constraint(expr=-log(1 + (625 + 1250*m.x291)/(m.x287*m.x276*m.x277*m.x278*m.x279)*(1 - 0.24*(1 - exp(-1.5*
