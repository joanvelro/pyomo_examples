#  MINLP written by GAMS Convert at 05/24/17 13:23:50
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.x1308 = Var(within=Reals,bounds=(0.1,100),initialize=0.1)

m.obj = Objective(expr=m.x1308, sense=minimize)
...
m.c1659 = Constraint(expr= - 1.33333333333333*m.x1307 + m.x1308 == 0)
