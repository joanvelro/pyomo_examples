...
min_matrix_recipe[('tank_a', 'pasteurizer', 'Product-A')] = 1
min_matrix_recipe[('pasteurizer', 'out_1a', 'Product-A')] = 1
min_matrix_recipe[('tank_b', 'pasteurizer', 'Product-B')] = 1
min_matrix_recipe[('pasteurizer', 'out_1b', 'Product-B')] = 1
max_matrix_recipe = min_matrix_recipe.copy()
max_matrix_recipe[('pasteurizer', 'crystallization_tank_1', 'Product-A')] = 1
max_matrix_recipe[('pasteurizer', 'crystallization_tank_2', 'Product-A')] = 1
max_matrix_recipe[('crystallization_tank_1', 'out_2a', 'Product-A')] = 1
max_matrix_recipe[('crystallization_tank_2', 'out_2a', 'Product-A')] = 1
max_matrix_recipe[('pasteurizer', 'crystallization_tank_1', 'Product-B')] = 1
max_matrix_recipe[('pasteurizer', 'crystallization_tank_2', 'Product-B')] = 1
max_matrix_recipe[('crystallization_tank_1', 'out_2b', 'Product-B')] = 1
max_matrix_recipe[('crystallization_tank_2', 'out_2b', 'Product-B')] = 1
...
model.batch_sizes_kg = pyomo.environ.Param(model.products, initialize={'Product-A': 15000, 'Product-B': 15000},
                                           within=pyomo.environ.Reals)
model.order_kg = pyomo.environ.Param(model.products, initialize={'Product-A': 3e4, 'Product-B': 1.5e4},
                                     within=pyomo.environ.Reals)
...
def constraint_output_from_crystallizer_1_1(model, i):
    return model.matrix_recipe[i, 'crystallization_tank_1', 'out_2a'] >= model.matrix_recipe[i, 'pasteurizer',
           ...
           model.batch_product[i, 'Product-A'] - 1
...
def constraint_output_from_crystallizer_1_3(model, i):
    return model.matrix_recipe[i, 'crystallization_tank_1', 'out_2a'] <= model.batch_product[i, 'Product-A']
...
def constraint_output_from_crystallizer_2_3(model, i):
    return model.matrix_recipe[i, 'crystallization_tank_2', 'out_2a'] <= model.batch_product[i, 'Product-A']
...
def constraint_output_from_crystallizer_3_1(model, i):
    return model.matrix_recipe[i, 'crystallization_tank_1', 'out_2b'] >= model.matrix_recipe[i, 'pasteurizer',
                                                                                             'crystallization_tank_1'] + \
           model.batch_product[i, 'Product-B'] - 1
...
def constraint_output_from_crystallizer_3_3(model, i):
    return model.matrix_recipe[i, 'crystallization_tank_1', 'out_2b'] <= model.batch_product[i, 'Product-B']
...
def constraint_output_from_crystallizer_4_3(model, i):
    return model.matrix_recipe[i, 'crystallization_tank_2', 'out_2b'] <= model.batch_product[i, 'Product-B']
