...
m.c56 = Constraint(expr=   m.b2 + m.b3 <= 1)

m.c57 = Constraint(expr=   m.b5 + m.b6 <= 1)

m.c58 = Constraint(expr=   m.b7 + m.b8 <= 1)

m.c59 = Constraint(expr= - m.b2 + m.b4 + m.b5 + m.b6 >= 0)

m.c60 = Constraint(expr= - m.b3 + m.b4 + m.b5 + m.b6 >= 0)

m.c61 = Constraint(expr= - m.b4 + m.b9 >= 0)

m.c62 = Constraint(expr=   m.b2 + m.b3 - m.b4 >= 0)

m.c63 = Constraint(expr=   m.b2 + m.b3 - m.b5 >= 0)

m.c64 = Constraint(expr= - m.b5 + m.b7 + m.b8 >= 0)

m.c65 = Constraint(expr=   m.b2 + m.b3 - m.b6 >= 0)

m.c66 = Constraint(expr= - m.b6 + m.b9 >= 0)

m.c67 = Constraint(expr=   m.b5 - m.b7 >= 0)

m.c68 = Constraint(expr=   m.b5 - m.b8 >= 0)
