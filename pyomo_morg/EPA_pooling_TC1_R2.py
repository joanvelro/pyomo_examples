...
m.c46 = Constraint(expr=-10*(1.521*m.x23 - 0.5161*m.x19*m.x23 - 0.0352*m.x25*m.x23 + 0.0628*m.x19*m.x19*m.x23 + 0.01*
                        m.x19*m.x25*m.x23 - 0.0022*m.x19*m.x19*m.x19*m.x23 - 0.0009*m.x19*m.x19*m.x25*m.x23) + m.x214
                         == 0)

m.c47 = Constraint(expr=-10*(1.521*m.x34 - 0.5161*m.x30*m.x34 - 0.0352*m.x36*m.x34 + 0.0628*m.x30*m.x30*m.x34 + 0.01*
                        m.x30*m.x36*m.x34 - 0.0022*m.x30*m.x30*m.x30*m.x34 - 0.0009*m.x30*m.x30*m.x36*m.x34) + m.x215
                         == 0)
...
m.c178 = Constraint(expr=-1000*(0.027*m.x166**2 - 0.3008*m.x166) + m.x194 == 1063.3)

m.c179 = Constraint(expr=-1000*(0.027*m.x167**2 - 0.3008*m.x167) + m.x195 == 1063.3)
