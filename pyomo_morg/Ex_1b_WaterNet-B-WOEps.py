...
m.obj = Objective(expr=0.1*(16800*m.x47**0.7 + 12600*m.x48**0.7) + 8000*m.x47 + 53.6*m.x48 + 0.1*(100*m.x23**0.6 + 100*
                       m.x24**0.6 + 100*m.x25**0.6 + 100*m.x26**0.6 + 100*m.x29**0.6 + 100*m.x30**0.6 + 100*m.x31**0.6
                        + 100*m.x32**0.6 + 100*m.x33**0.6 + 100*m.x34**0.6 + 100*m.x35**0.6 + 100*m.x36**0.6 + 100*m.x37
                       **0.6 + 100*m.x38**0.6 + 100*m.x39**0.6 + 100*m.x40**0.6 + 100*m.x43**0.6 + 100*m.x44**0.6 + 100*
                       m.x41**0.6 + 100*m.x42**0.6) + 48*m.x23 + 48*m.x24 + 48*m.x25 + 48*m.x26 + 48*m.x29 + 48*m.x30 + 
                       48*m.x31 + 48*m.x32 + 48*m.x33 + 48*m.x34 + 48*m.x35 + 48*m.x36 + 48*m.x37 + 48*m.x38 + 48*m.x39
                        + 48*m.x40 + 48*m.x41 + 48*m.x42 + 48*m.x43 + 48*m.x44 + 0.6*m.b1 + 0.6*m.b2 + 0.6*m.b3
                        + 0.6*m.b4 + 0.6*m.b5 + 0.6*m.b6 + 0.6*m.b7 + 0.6*m.b8 + 0.6*m.b9 + 0.6*m.b10 + 0.6*m.b11
                        + 0.6*m.b12 + 0.6*m.b13 + 0.6*m.b14 + 0.6*m.b15 + 0.6*m.b16 + 0.6*m.b17 + 0.6*m.b18 + 0.6*m.b19
                        + 0.6*m.b20 + 8000*m.x22, sense=minimize)
