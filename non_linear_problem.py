...
class Engine(object):
    ...
    def build_model(self):
        ...
        self.model.x = pyo.Var(self.model.I, domain=pyo.PositiveIntegers, initialize=0)
        self.model.slack = pyo.Var(self.model.I, domain=pyo.PositiveIntegers, initialize=0)
        self.model.b = pyo.Var(self.model.I, domain=pyo.Binary, initialize=0)
