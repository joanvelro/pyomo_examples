...
def objective_rule(model):
    ...
    total_income = sum(model.A[i, j] * model.x[t, i] * model.prices[t, j] for j in model.j for t in model.t for i in model.i)
    return total_income - total_cost


model.OF = pyo.Objective(rule=objective_rule, sense=pyo.maximize, doc='minimize cost')
print('\n')
print('\n')
print('--- Model Summary ---')
print(model.pprint())
